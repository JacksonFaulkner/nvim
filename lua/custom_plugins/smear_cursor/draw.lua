local color = require("custom_plugins.smear_cursor.color")
local config = require("custom_plugins.smear_cursor.config")
local atan_cached = require("custom_plugins.smear_cursor.math").atan_cached
local round = require("custom_plugins.smear_cursor.math").round
local M = {}
